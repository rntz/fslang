...
\usepackage{rntzfont}
\RequirePackage[osf,scaled=1.007,scaled=1.033,scaled=1.02,]{AlegreyaSans}
...
%\renewcommand\of{\mathbin{\cdot}}
%\renewcommand\cxsep{\mathrel{:}}

%\renewcommand\of{~}
%\renewcommand\cxsep{\mathrel{\cdot}}
...
\noindent
Judgments and their interpretation:
\[
...
\noindent
Inference rules and their rough denotational justifications:
