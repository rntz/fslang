...
\documentclass[nonacm, sigplan, screen, dvipsnames]{acmart}
...
\newcommand\ox\otimes
\newcommand\typename\text
\newcommand\bool{\name{bool}}
\newcommand\maybe[1]{\ensuremath{\typename{maybe}~{#1}}}

%% need \usepackage{accent} for these
...
\begin{figure}
  ...
  %\begin{align*}
    ...
    \tfalse &=& \tnil\\
    \ttrue  &=& \tjust ()\\
    t \tand u &=& \letjust {\textunderscore} t u
  %\end{align*}\vspace{-1\baselineskip}
  \end{array}\]\vspace{-1\baselineskip}
  \caption{Primitive functions and definitions}
